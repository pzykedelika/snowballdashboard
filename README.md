...
👉 **Powerful Search**: Quickly find the best stocks with an intelligent search system that helps you navigate through Snowball.
...
```bash
git clone https://github.com/adrianhajdin/Snowball_stock-tracker-app.git
cd Snowball_stock-tracker-app
```
